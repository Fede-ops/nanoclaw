...
const ICONS = {
  ...
  signal: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M9.504.43a1.148 1.148 0 0 0-.595.327L.736 8.93c-.473.474-.4 1.327.122 1.71.382.283 1.06.265 1.402-.036l3.84-3.34a4.55 4.55 0 0 0-.012.272v9.06c0 2.521 2.07 4.591 4.59 4.591H17a.61.61 0 0 0 .61-.61v-1.66a.61.61 0 0 0-.61-.61h-6.32a2.34 2.34 0 0 1-2.34-2.34v-9.06c0-.077.013-.155.018-.232l3.79 3.291a.97.97 0 0 0 1.402.036c.522-.382.595-1.235.122-1.71L5.499.757a1.149 1.149 0 0 0-.806-.327c-.014.001-.027 0-.04 0z M11.5 0a11.5 11.5 0 1 0 0 23 11.5 11.5 0 0 0 0-23zm0 2.07a9.43 9.43 0 1 1 0 18.86 9.43 9.43 0 0 1 0-18.86z"/></svg>`,
};
